...
describe('Register Test', () => {
  it('allows user to sign up and login', () => {
    ...
    cy.intercept('GET', '/api/accounts/*/balance', { statusCode: 200, body: { balance: 1000 } }).as('getBalance');
    cy.intercept('GET', '/api/accounts/*', { statusCode: 200, body: { email: 'testuser', alias: 'Test', cvu: '0000' } }).as('getDetails');
