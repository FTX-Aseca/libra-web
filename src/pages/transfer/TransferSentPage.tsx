...
const TransferSentPage: React.FC = () => {
  ...
  const { amount, recipientAlias } = (location.state as { amount: number; recipientAlias: string }) || {
    amount: 0,
    recipientAlias: 'N/A',
  };
  ...
  return (
    <div className="min-h-screen bg-[#131A1A] flex flex-col justify-center items-center pb-16 px-4">
      <div className="text-center w-full max-w-sm">
        ...
        <h1 className="text-2xl font-bold text-white mb-4">Transfer Sent Successfully!</h1>
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow mb-8">
          ...
          <div className="flex justify-between text-lg">
            ...
            <span className="text-teal-400 font-semibold">${amount.toFixed(2)}</span>
          </div>
        </div>
