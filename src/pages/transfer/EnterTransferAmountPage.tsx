...
const EnterTransferAmountPage: React.FC = () => {
  ...
  const { recipientAlias, transferType } = (location.state as {
    recipientAlias: string;
    transferType: IdentifierType;
  }) || { recipientAlias: "Unknown", transferType: IdentifierType.ALIAS };
  ...
  const handleConfirmTransfer = async () => {
    ...
    try {
      ...
      navigate("/transfer/sent", {
        state: { amount: parseFloat(amount), recipientAlias },
      });
    } catch (err) {
